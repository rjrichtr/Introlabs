<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Introlabs.Master" CodeBehind="GeneralData.aspx.vb" Inherits="Introlabs.GeneralData" %>
        ...
        <div class="col-md-12 form-inline">
            ...
            <div class="input-group mb-3 mr-3">
                ...
                <asp:SqlDataSource ID="Room_sds" runat="server" ConnectionString="<%$ ConnectionStrings:MM_OCS_SQL_STRING %>"
                    SelectCommand="SELECT DISTINCT room FROM room_sections WHERE (page = 'GeneralData')"></asp:SqlDataSource>
            </div>
